...
// ✅ UPDATED: Services aligned with CV skills
const SERVICES = [
  ...
  return (
    <>
      <style>{`
        ...
        .form-chip:hover {
          background: rgba(244,93,34,0.06);
          border-color: rgba(244,93,34,0.3);
          color: #f45d22;
        }
        .form-chip.active {
      ...
      <section id="contact" className="contact-section">
        <div className="contact-inner">
          ...
          <div className="contact-left">
            ...
            {/* ✅ UPDATED: tagline is more direct and CV-aligned */}
